...
function template_body_above()
{
	...
	<header>
		<div class="logodiyar">
			<a href="'.$scripturl.'"><img class="logost" src="',empty($context['header_logo_url_html_safe']) ? $settings['images_url'].'/theme/img/logo.png' : $context['header_logo_url_html_safe'],'" alt="',empty($settings['site_slogan']) ? 'Logo' : $settings['site_slogan'],'" />
			</a>
		</div>
		<div class="giris">';
	...
	<div class="menuyeri">
		<div class="gizlilogo">
			<div class="logogizli">
				<a href="'.$scripturl.'">
					<img src="'.$settings['images_url'].'/theme/img/logo.png" alt="', empty($settings['site_slogan']) ? 'Logo' : $settings['site_slogan'] ,'" />
				</a>
			</div>
		</div>';
...
function template_body_below()
{
	...
	<div class="altmenu">
		<a href="'.$scripturl.'">
			<img src="'.$settings['images_url'].'/theme/img/logo2.png" alt="',empty($settings['site_slogan']) ? 'Logo' : $settings['site_slogan'],'" />
		</a>
		<div class="sosyalan">
			<a href=""><img src="'.$settings['images_url'].'/theme/img/fb-ico.jpg" alt="Facebook" /></a>
			<a href=""><img src="'.$settings['images_url'].'/theme/img/insta-ico.jpg" alt="İnstegram" /></a>
			<a href=""><img src="'.$settings['images_url'].'/theme/img/gp-ico.jpg" alt="Google+" /></a>
			<a href=""><img src="'.$settings['images_url'].'/theme/img/in-ico.jpg" alt="İn" /></a>
			<a href=""><img src="'.$settings['images_url'].'/theme/img/tw-ico.jpg" alt="Twitter" /></a>
			<a href=""><img src="'.$settings['images_url'].'/theme/img/twitch-ico.jpg" alt="Twitch" /></a>
			<a href=""><img src="'.$settings['images_url'].'/theme/img/pint-ico.jpg" alt="Pint" /></a>
			<a href=""><img src="'.$settings['images_url'].'/theme/img/yt-ico.jpg" alt="Youtube" /></a>
			<a href=""><img src="'.$settings['images_url'].'/theme/img/steam-ico.jpg" alt="Steam" /></a>
		</div>
	</div>';
	...
	<div class="altacik">';
		...
		echo '
		<ul>
			<li class="floatright"><a href="', $scripturl, '?action=help">', $txt['help'], '</a> ', (!empty($modSettings['requireAgreement'])) ? '| <a href="' . $scripturl . '?action=agreement">' . $txt['terms_and_rules'] . '</a>' : '', ' | <a href="#wrapper">', $txt['go_up'], ' &#9650;</a></li>
			<li class="copyright">', theme_copyright(), '</li>
		</ul>';

		echo '<div class="ortagl">', theme_huu(), '</div>';

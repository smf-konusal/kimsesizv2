...
function template_settings()
{
	...
	$context['theme_settings'] = array(
		...
		array(
			...
			'default_value' => DEFAULT_BESE_COLOR,
			'type' => 'color',
		),
		array(
			'id' => 'bese_color_primary',
			'label' => $txt['bese_color_primary'],
			'description' => str_replace('%color%', DEFAULT_BESE_COLOR_PRIMARY, $txt['bese_color_defaulte']),
			'default_value' => DEFAULT_BESE_COLOR_PRIMARY,
			'type' => 'color',
		),
		array(
			'id' => 'bese_color_secondary',
			'label' => $txt['bese_color_secondary'],
			'description' => str_replace('%color%', DEFAULT_BESE_COLOR_SECONDARY, $txt['bese_color_defaulte']),
			'default_value' => DEFAULT_BESE_COLOR_SECONDARY,
			'type' => 'color',
		),
		array(
			'id' => 'bese_color_kimsesiz',
			'label' => $txt['bese_color_kimsesiz_title'],
			'description' => str_replace('%color%', $txt['bese_color_kimsesiz'], $txt['bese_color_defaulte']),
			'default_value' => $txt['bese_color_kimsesiz'],
			'type' => 'color',
		),
		array(
			'id' => 'bese_color_kimsesiz_ex',
			'label' => $txt['bese_color_kimsesiz_ex_title'],
			'description' => str_replace('%color%', $txt['bese_color_kimsesiz_ex'], $txt['bese_color_defaulte']),
			'default_value' => $txt['bese_color_kimsesiz_ex'],
			'type' => 'color',
		),
